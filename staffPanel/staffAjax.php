...
if(isset($_REQUEST['task']) && $_REQUEST['task'] === 'showOrders'){
    $orderRes = $orderObj->getOrderStaff($_REQUEST['staffID']);
    if($orderRes){
...
if(isset($_REQUEST['task']) && $_REQUEST['task'] === 'showRCOrders'){
    $orderRes = $orderObj->getREADYCOMPLETEOrderStaff($_REQUEST['staffID']);
    if($orderRes){
        foreach($orderRes as $row){
            ?>
            <tr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            if($resultBill){
                                ...
                                if($pmValue === 'Pick'){
                                    $resultBill = $orderObj->getBillingInfoPiCK($_REQUEST['paymentID']);
                                    $billData = $resultBill->fetch_assoc();
                                    ?>
                                    <div class="row">
                                        <div class="col-md-6 label">Delivery Charges:</div>
                                    ...
                                    $resultBillBD = $orderObj->getBillingInfoBD($_REQUEST['paymentID']);
                                    if($resultBillBD){
                                        $billDataBD = $resultBillBD->fetch_assoc();
                                        ?>
                                        <div class="row">
                                        <div class="col-md-6 label">Postal Charges:</div>
                                        <div class="col fw-bold">Rs <?=$billDataBD['postal_charges']?></div>
                                         </div>
                                        <div class="row mt-3">
                                        <div class="col-md-6 label">Total:</div>
                                        <div class="col fw-bold">Rs <?=$billDataBD['Total']?></div>
                                        </div>
                                        <?php
                                    }else{
                                        ?>
                                    <div class="row">
                                        <div class="col-md-6 label">Postal Charges:</div>
                                        <div class="col fw-bold">None</div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-6 label">Total:</div>
                                        <div class="col fw-bold">None</div>
